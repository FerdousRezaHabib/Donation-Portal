    ...
    private void loadDonorImage() {
        try {
            if (donorImageView != null) {
                ...
                /* Uncomment this if your Donor model has photo support:
                if (donor.getPhoto() != null && donor.getPhoto().length > 0) {
                    ByteArrayInputStream bis = new ByteArrayInputStream(donor.getPhoto());
